...
import type { ServiceTypeResponse, ServiceRequest } from "@digital-barbershop/shared-types";
                                        ...
                                        return (
                                            <Field data-invalid={isInvalid}>
                                                ...
                                                <Input
                                                    ...
                                                    type="text"
                                                    inputMode="numeric"
                                                    value={field.state.value && field.state.value > 0 ? field.state.value.toString() : ''}
                                                    onBlur={field.handleBlur}
                                                    onChange={(e) => {
                                                        const val = e.target.value.replace(/[^0-9]/g, '');
                                                        field.handleChange(val === '' ? 0 : parseInt(val) || 0);
                                                    }}
                                                    placeholder="1"
                                                    className="h-11"
                                                    aria-invalid={isInvalid}
