        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-4">{plan.staffLimit}</p>

              <div className="mb-6">
                <p className="text-xs text-muted-foreground">Starting at</p>
                <div className="flex items-baseline gap-1">
                  <h2 className="text-2xl font-bold text-foreground">KES {plan.price.toLocaleString()}</h2>
          ...
          {[
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-foreground font-medium">{bill.invoice}</p>
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-sm text-foreground font-medium">KES {bill.amount.toLocaleString()}</p>
      ...
      <div className="bg-card rounded-xl p-6 border border-border">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 border border-border rounded-lg">
            <div>
              <p className="text-sm text-foreground mb-1 font-medium">One-time Setup & Training</p>
              <p className="text-xs text-muted-foreground">Professional onboarding for your team</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-foreground font-medium">KES 10,000</p>
          ...
          <div className="flex items-center justify-between p-4 border border-border rounded-lg">
            <div>
              <p className="text-sm text-foreground mb-1 font-medium">Priority Support Upgrade</p>
              <p className="text-xs text-muted-foreground">24/7 dedicated support line</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-foreground font-medium">+KES 1,500/mo</p>
