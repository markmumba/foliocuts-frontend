  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-primary mb-1">Services & Pricing</h2>
          <p className="text-sm text-gray-500">Manage services offered at your shop</p>
        </div>
        <Button
      ...
      {groupedServices.length > 0 ? (
        groupedServices.map((group) => (
          <div key={group.type} className="bg-white rounded-xl p-6 border border-gray-200">
            <h3 className="text-lg font-semibold text-primary mb-4">{group.type} Services</h3>
              ...
              {group.services.map((service) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-primary font-medium mb-1">{service.serviceName}</p>
                      <p className="text-sm text-gray-500">ID: {service.serviceId}</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className="text-lg font-semibold text-primary">KES {service.servicePrice.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-xl p-12 border border-gray-200 text-center">
          ...
          <h3 className="text-lg font-semibold text-primary mb-2">No Services Yet</h3>
