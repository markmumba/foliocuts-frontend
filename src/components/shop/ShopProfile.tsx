      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-1">{formData.businessName}</h2>
              <p className="text-sm text-gray-500 mb-2">{formData.subdomain}.foliocuts.com</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm text-gray-600 mb-2">Shop Name</label>
            {isEditing ? (
              <input
                type="text"
              ...
              <p className="text-primary">{formData.businessName}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-primary">{formData.phoneNumber}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-primary">{formData.subdomain}.foliocuts.com</p>
            )}
          </div>

          <div>
            <label className="block text-sm text-gray-600 mb-2">M-Pesa Till Number</label>
            {isEditing ? (
              <input
                type="text"
              ...
              <p className="text-primary">{formData.mpesaTillNo || 'Not set'}</p>
            )}
          </div>

          <div>
            <label className="block text-sm text-gray-600 mb-2">M-Pesa Business Short Code</label>
            {isEditing ? (
              <input
                type="text"
              ...
              <p className="text-primary">{formData.mpesaBusinessShortCode || 'Not set'}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-primary">{formData.numberOfUsers}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-primary">{tenant.status}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-primary">{tenant.subscriptionPlan}</h3>
            </div>
          </div>
        </div>
      </div>
